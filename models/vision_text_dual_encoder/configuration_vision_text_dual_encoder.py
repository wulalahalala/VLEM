...
class VisionTextDualEncoderForClassificationConfig(PretrainedConfig):
    r"""
    ...
    def __init__(self, projection_dim=512, num_classes=2, **kwargs):
    ...
    @classmethod
    def from_vision_text_configs(cls, vision_config: PretrainedConfig, text_config: PretrainedConfig, num_classes, max_length, patch_row_num,cca_weight,**kwargs):
        r"""
        ...
        return cls(vision_config=vision_config.to_dict(), text_config=text_config.to_dict(), num_classes=num_classes, max_length=max_length, patch_row_num=patch_row_num,cca_weight=cca_weight,**kwargs)
